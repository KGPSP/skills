...
GEN_FILE=""
for candidate in "$AGENTS_DIR/swarm-generator.md" "$AGENTS_DIR/generator.md" "$AGENTS_DIR/generator.yaml"; do
...
EVAL_FILE=""
for candidate in "$AGENTS_DIR/swarm-evaluator.md" "$AGENTS_DIR/evaluator.md" "$AGENTS_DIR/evaluator.yaml"; do
...
PLAN_FILE=""
for candidate in "$AGENTS_DIR/swarm-planner.md" "$AGENTS_DIR/planner.md" "$AGENTS_DIR/planner.yaml"; do
