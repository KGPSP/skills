...
```mermaid
flowchart LR
    Q["Pytanie wykonawcy"] --> A["1. Identyfikacja obszaru<br/>(01_rejestr_pytan.md)"]
    A --> B["2. Mapowanie na artykuł Pzp<br/>(pzp-articles-map.md)"]
    B --> C["3. Sprawdzenie ustawy<br/>(D20192019Lj.md)"]
    C --> D["4. Ewent. sprawdzenie regulaminu<br/>(regulamin_kg_psp.md)"]
    D --> E["5. Sprawdzenie wzoru umowy<br/>(szablon-1-umowa_*.md)<br/>jeśli pytanie dot. umowy"]
    E --> F["6. Analiza 3 hipotez<br/>(02_analiza_hipotez.md)"]
    F --> G["7. Odpowiedź<br/>(03_odpowiedzi_dla_wykonawcow.md)"]
```
